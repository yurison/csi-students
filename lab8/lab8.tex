...
\usepackage{caption}
\captionsetup[table]{labelformat=simple, labelsep = endash, justification = raggedright, singlelinecheck = off, width = 0.78\textwidth}
...
\begin{figure}[h]
	...
	\center{\includegraphics[width=0.8\linewidth]{0.png}}
...
\begin{figure}
	\center{\includegraphics[width=0.8\linewidth]{5}}
